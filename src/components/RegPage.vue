<template>
    ...
    <div class="container" style ="margin-left: 222px;">
      ...
      <input type="text" for="country" name="country" class="phone" placeholder="Country" required v-model="person.country">
       ...
       <select name="Entity" for="Entity" v-model="person.Entity">
...
<option value ="Payroll Analyst">Payroll Analyst</option>
      ...
      <input type="text" class="company" placeholder="Company Id" required v-model="person.companyid" style="
    margin-bottom: -8px;" >
                        </div>
    ...
    margin-bottom: -8px;" >
                        ...
                        <div class="input-field">
                             ...
                             <input type="text" name="PhoneNumber" for="PhoneNumber" class="username" placeholder="User Id" required v-model="person.phoneNumber" style="width: 100%; 
    margin-bottom: -8px;" >
                        </div>
     ...
     <h1 style="text-align: center">Security Questions</h1>
               <h3 style= "text-align= center" >please answer security Quetions </h3>
      <div>
        <lable>What is your favourite food/dish ?</lable>
        <input type="text" name="ans1" for="ans1" placeholder="Answer" v-model="person.ans1" /> 
        </div>
      
      <div><label for="ans2"> is your childhood hero ?</label>
      <input type="text" for="ans2" name="ans2" placeholder="Answer" v-model="person.ans2" /> </div>
      
      <div><lable for="ans3">What is the name of your favourite pet ? </lable>
      <input type="text" for="ans3" name="ans3" placeholder="Answer" v-model="person.ans3" /> </div>
       
      <div><label for="ans4"> what city you were born ? </label>
      <input type="text" for="ans4" name="ans4" placeholder="Answer" v-model="person.ans4" />  </div>
      
      <div><lable for="ans5">What is the name of your first school ?</lable>
      <input type="text" for="ans5" name="ans5" placeholder="Answer" v-model="person.ans5" /> </div>
